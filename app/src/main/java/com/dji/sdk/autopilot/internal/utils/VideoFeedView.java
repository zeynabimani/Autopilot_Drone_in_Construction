package com.dji.sdk.autopilot.internal.utils;
...
//                    myCurrentFrame = codecManager.getRgbaData(codecManager.getVideoWidth(), codecManager.getVideoHeight());
                }
            }
        };
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surface, int width, int height) {
        Log.d("Debug", "www: " + width);
        Log.d("Debug", "hhh: " + height);
